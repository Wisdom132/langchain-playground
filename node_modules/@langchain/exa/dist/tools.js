...
* </details>
*/
var ExaSearchResults = class extends Tool {
	static lc_name() {
...
var ExaFindSimilarResults = class extends Tool {
	static lc_name() {
		return "ExaFindSimilarResults";
	}
	description = "A wrapper around Exa Find Similar. Input should be an Exa-optimized query. Output is a JSON array of the query results";
...
//#endregion
export { ExaFindSimilarResults, ExaSearchResults };
