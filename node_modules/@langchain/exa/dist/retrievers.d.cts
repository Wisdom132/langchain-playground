 ...
 */
interface ExaRetrieverFields<T extends ContentsOptions = {
  text: true;
}> extends BaseRetrieverInput {
  client: Exa;
  searchArgs?: RegularSearchOptions & T;
}
declare function _getMetadata<T extends ContentsOptions = {
  text: true;
 ...
 * ```
 */
declare class ExaRetriever<T extends ContentsOptions = {
  text: true;
...
//#endregion
export { ExaRetriever, ExaRetrieverFields, _getMetadata };
