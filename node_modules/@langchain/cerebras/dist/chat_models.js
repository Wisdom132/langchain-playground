...
* <br />
*/
var ChatCerebras = class extends BaseChatModel {
	static lc_name() {
		return "ChatCerebras";
	}
	...
	*/
	...
	withStructuredOutput(outputSchema, config) {
		...
		return assembleStructuredOutputPipeline(this.bindTools(tools, { tool_choice: tools[0].function.name }), RunnableLambda.from((input) => {
